...
cutoutsLeft = [
    ...
    [26,pcbThickness+1.9,7.6,4.1,0,yappRectangle,yappCenter],           //dsp1
    [39.5,pcbThickness+1.9,7.6,4.1,0,yappRectangle,yappCenter],         //dsp2
    [54,pcbThickness+3.5,7,7.4,0,yappRectangle,yappCenter]            //audio
];
// front cutouts
cutoutsFront = [
    [9,pcbThickness+8,15.2,16.3,0,yappRectangle,yappCenter],        //usb1
    [27,pcbThickness+8,15.2,16.3,0,yappRectangle,yappCenter],       //usb2
    [45.75,pcbThickness+6.8,16.4,13.9,0,yappRectangle,yappCenter]   //ethernet
];
...
cutoutsBack = [
    // Cutout for vent
    [shellWidth/2,lidWallHeight+2,3,12,0,yappRectangle,yappCenter,yappCoordBox],
    [shellWidth/2-7,lidWallHeight+2,3,12,0,yappRectangle,yappCenter,yappCoordBox],
    [shellWidth/2+7,lidWallHeight+2,3,12,0,yappRectangle,yappCenter,yappCoordBox],
    [shellWidth/2-14,lidWallHeight+2,3,12,0,yappRectangle,yappCenter,yappCoordBox],
    [shellWidth/2+14,lidWallHeight+2,3,12,0,yappRectangle,yappCenter,yappCoordBox],
    [shellWidth/2-21,lidWallHeight+2,3,12,0,yappRectangle,yappCenter,yappCoordBox],
    [shellWidth/2+21,lidWallHeight+2,3,12,0,yappRectangle,yappCenter,yappCoordBox]
];
...
module hookLidInside ()
{
    ...
    // IO standups
    translate ([shellLength-wallThickness*2,19,-lidWallHeight]) ioStand();
    translate ([shellLength-wallThickness*2,37.1,-lidWallHeight]) ioStand();
}
